...
最初は「医療ソーシャルワーカー」が進行役としてカンファレンスの開始を宣言し、患者の背景を簡単に説明した上で、学生・新人（ユーザー）に最初の意見や質問を求める形でスタートしてください。
【重要】ただしその後は、進行役のソーシャルワーカーだけでなく、看護師、管理栄養士、STなど、あらゆる参加職種がそれぞれの専門的視点から、学生・新人に対して積極的に直接質問を投げかけてください。一人の職種（ソーシャルワーカーなど）ばかりが質問しないようにしてください。
`;
